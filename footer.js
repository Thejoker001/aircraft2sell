...
(function(){
  ...
  var TRANSLATED_PAGES = ['index.html','search.html','listing.html','post-listing.html',
    ...
    'blog.html','guide-acheteur.html','assurance-aeronef-guide.html','comment-financer-avion-leger.html',
  ...
  var I18N = {
    fr: { desc:'La marketplace aéronautique européenne. Achetez et vendez un aéronef entre particuliers et professionnels, sans commission.',
      ...
      colResources:'Ressources', buyerGuide:'Guide de l\'acheteur', blog:'Blog & conseils', faq:'FAQ', inspection:'Inspection pré-achat', inspectorsDir:'Annuaire d\'inspecteurs', financing:'Financer son avion', marketTrends:'Tendances du marché',
    ...
    en: { desc:'The European aircraft marketplace. Buy and sell aircraft between private owners and professionals, with zero commission.',
      ...
      colResources:'Resources', buyerGuide:'Buyer\'s guide', blog:'Blog & advice', faq:'FAQ', inspection:'Pre-purchase inspection', inspectorsDir:'Inspector directory', financing:'Finance your aircraft', marketTrends:'Market trends',
    ...
    de: { desc:'Der europäische Marktplatz für Luftfahrzeuge. Kaufen und verkaufen Sie zwischen Privatpersonen und Profis – ohne Provision.',
      ...
      colResources:'Ressourcen', buyerGuide:'Käuferratgeber', blog:'Blog & Tipps', faq:'FAQ', inspection:'Vorkaufinspektion', inspectorsDir:'Inspektorenverzeichnis', financing:'Flugzeug finanzieren', marketTrends:'Markttrends',
    ...
    it: { desc:'Il marketplace aeronautico europeo. Compra e vendi aeromobili tra privati e professionisti, senza commissioni.',
      ...
      colResources:'Risorse', buyerGuide:'Guida per l\'acquirente', blog:'Blog & consigli', faq:'FAQ', inspection:'Ispezione pre-acquisto', inspectorsDir:'Elenco ispettori', financing:'Finanzia il tuo aereo', marketTrends:'Tendenze di mercato',
    ...
    es: { desc:'El marketplace aeronáutico europeo. Compra y vende aeronaves entre particulares y profesionales, sin comisión.',
      ...
      colResources:'Recursos', buyerGuide:'Guía del comprador', blog:'Blog & consejos', faq:'FAQ', inspection:'Inspección previa a la compra', inspectorsDir:'Directorio de inspectores', financing:'Financiar tu avión', marketTrends:'Tendencias del mercado',
    ...
    et: { desc:'Euroopa lennukiturg. Osta ja müü õhusõidukeid eraomanike ja professionaalide vahel, vahendustasuta.',
      ...
      colResources:'Ressursid', buyerGuide:'Ostja juhend', blog:'Blogi ja nõuanded', faq:'KKK', inspection:'Ostueelne ülevaatus', inspectorsDir:'Inspektorite kataloog', financing:'Rahasta oma lennukit', marketTrends:'Turusuundumused',
      ...
      '<footer class="a2s-footer">',
        '<div class="footer-inner">',
          ...
          col(t('colResources'), [
            ...
            [href('inspection-pre-achat-avion.html'), t('inspection')], [href('inspecteurs.html'), t('inspectorsDir')], [href('financement.html'), t('financing')], [href('tendances-marche.html'), t('marketTrends')]
          ]),
          col(t('colCompany'), [
