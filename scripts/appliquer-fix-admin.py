#!/usr/bin/env python3
"""Applique supabase/fix-suppression-admin.sql via la Management API Supabase.

Usage :
  SUPABASE_ACCESS_TOKEN=sbp_xxx python3 scripts/appliquer-fix-admin.py
  SUPABASE_ACCESS_TOKEN=sbp_xxx python3 scripts/appliquer-fix-admin.py --dry
"""
import json, os, pathlib, sys, urllib.request, urllib.error

RACINE = pathlib.Path(__file__).resolve().parent.parent
SQL = RACINE / "supabase" / "fix-suppression-admin.sql"
...
print("Vérification recommandée : scripts/verifier-fix-admin.py")
