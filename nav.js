...
(function(){
  ...
  var I18N = {
    fr: { buy:'Acheter', sell:'Vendre', pro:'Professionnels', guide:'Guide', blog:'Blog', faq:'FAQ', contact:'Contact',
      ...
      mmBuy:'Acheter', mmSellPro:'Vendre', mmSellMy:'Vendre mon aéronef', mmResources:'Aide & ressources', mmGuide:'Guide de l\'acheteur', mmLogin:'Se connecter', mmSignup:'Créer un compte', mmEstimate:'Estimer mon aéronef', mmAlerts:'Alertes email', mmFinancing:'Simulateur de financement' },
    en: { buy:'Buy', sell:'Sell', pro:'Dealers', guide:'Guide', blog:'Blog', faq:'FAQ', contact:'Contact',
      ...
      mmBuy:'Buy', mmSellPro:'Sell', mmSellMy:'Sell my aircraft', mmResources:'Help & resources', mmGuide:'Buyer\'s guide', mmLogin:'Log in', mmSignup:'Create an account', mmEstimate:'Value my aircraft', mmAlerts:'Email alerts', mmFinancing:'Financing calculator' },
    de: { buy:'Kaufen', sell:'Verkaufen', pro:'Händler', guide:'Ratgeber', blog:'Blog', faq:'FAQ', contact:'Kontakt',
      ...
      mmBuy:'Kaufen', mmSellPro:'Verkaufen', mmSellMy:'Mein Flugzeug verkaufen', mmResources:'Hilfe & Ressourcen', mmGuide:'Käuferratgeber', mmLogin:'Anmelden', mmSignup:'Konto erstellen', mmEstimate:'Flugzeug bewerten', mmAlerts:'E-Mail-Alarme', mmFinancing:'Finanzierungsrechner' },
    it: { buy:'Acquista', sell:'Vendi', pro:'Rivenditori', guide:'Guida', blog:'Blog', faq:'FAQ', contact:'Contatto',
      ...
      mmBuy:'Acquista', mmSellPro:'Vendi', mmSellMy:'Vendi il mio aereo', mmResources:'Aiuto e risorse', mmGuide:'Guida per l\'acquirente', mmLogin:'Accedi', mmSignup:'Crea un account', mmEstimate:'Valuta il mio aereo', mmAlerts:'Avvisi email', mmFinancing:'Simulatore di finanziamento' },
    es: { buy:'Comprar', sell:'Vender', pro:'Distribuidores', guide:'Guía', blog:'Blog', faq:'FAQ', contact:'Contacto',
      ...
      mmBuy:'Comprar', mmSellPro:'Vender', mmSellMy:'Vender mi avión', mmResources:'Ayuda y recursos', mmGuide:'Guía del comprador', mmLogin:'Acceder', mmSignup:'Crear una cuenta', mmEstimate:'Valorar mi avión', mmAlerts:'Alertas por email', mmFinancing:'Simulador de financiación' },
    et: { buy:'Osta', sell:'Müü', pro:'Edasimüüjad', guide:'Juhend', blog:'Blogi', faq:'KKK', contact:'Kontakt',
      ...
      mmBuy:'Osta', mmSellPro:'Müü', mmSellMy:'Müü oma õhusõiduk', mmResources:'Abi ja ressursid', mmGuide:'Ostja juhend', mmLogin:'Logi sisse', mmSignup:'Loo konto', mmEstimate:'Hinda oma õhusõidukit', mmAlerts:'E-posti teavitused', mmFinancing:'Rahastamise kalkulaator' }
  };
